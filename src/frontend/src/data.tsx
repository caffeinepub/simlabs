...
export const SERVICES: Service[] = [
  {
    ...
    tag: "Immersive Training · Simulation · Product Experience · Design Studies · Sales & Marketing · Multi-user Collaboration · Digital Twins · AI Adaptive Learning · VR Platforms · Aerospace · Defence · Healthcare · Automotive · Manufacturing",
